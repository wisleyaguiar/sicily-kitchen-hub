      ...
      <section id="cooking" className="py-12 px-5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-4xl md:text-6xl uppercase text-primary">
              One for the Pan.
              <br />
              One for the Plate.
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <article className="bg-[var(--brand-cream)] border-4 border-foreground rounded-3xl p-8 relative overflow-hidden">
              ...
              <p className="mt-3 text-muted-foreground">
                For everyday cooking with real extra virgin olive oil. Perfect for preparing
                recipes, grilling, sautéing and elevating the quality of your food from the very
                beginning.
              </p>
            </article>
            <article className="bg-[var(--brand-cream)] border-4 border-foreground rounded-3xl p-8 relative overflow-hidden">
              ...
              <p className="mt-3 text-muted-foreground">
                For using after the dish is ready. Perfect for pasta, pizza, salads, bread, eggs,
                vegetables, meats, fish, bowls and soups.
              </p>
            </article>
          </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center md:text-left">
                ...
                <p className="mt-4 text-base md:text-lg opacity-95 max-w-md">
                  Cooking + Finishing. The most complete way to live the CIAO! experience. One for
                  the pan, one for the plate.
                </p>
                <a
                  href="#shop"
                  className="inline-flex items-center justify-center mt-8 bg-background text-foreground px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-background hover:bg-foreground hover:text-background hover:outline-foreground transition shadow-lg leading-none btn-pulse-white"
                >
      ...
      <section id="infused" className="py-12 px-5 bg-[var(--brand-cream)]">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="text-center mb-10">
            <h2 className="text-4xl md:text-5xl uppercase leading-[1.1]">
              More flavor in seconds.
            </h2>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  img: rosemaryContext,
                  icon: iconRosemary,
                  note: "Aromatic & herbal.",
                  tint: "bg-[oklch(0.85_0.06_85)] text-foreground",
                },
                {
                  name: "Basil",
                  img: basilContext,
                  icon: iconBasil,
                  note: "Fresh Italian basil.",
                  tint: "bg-secondary text-secondary-foreground",
                },
              ].map((p) => (
                <article
                  key={p.name}
                  className={`${p.tint} rounded-3xl overflow-hidden border-4 border-foreground hover:-translate-y-1 transition relative min-w-[140px] sm:min-w-[160px]`}
                >
          ...
          <p className="text-center mt-10 text-sm md:text-base text-muted-foreground">
            Perfect for pizza night, pasta night, bread, appetizers and special meals at home.
          </p>
          <div className="text-center mt-6">
            <a
              href="#shop"
              className="inline-flex items-center justify-center bg-foreground text-background px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-foreground hover:bg-primary hover:outline-primary transition leading-none btn-pulse-black"
            >
