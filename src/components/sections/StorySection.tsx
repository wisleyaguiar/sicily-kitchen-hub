        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-[1fr_1.05fr] gap-6 md:gap-8 items-center">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-5 text-lg text-muted-foreground">
              CIAO! combines quality, aesthetics and practicality — a product designed to live on
              your counter and elevate every meal.
            </p>
            ...
            <p className="mt-10 ciao-script text-3xl text-primary">
              Use better olive oil every day.
            </p>
            <a
              href="#shop"
              className="inline-flex items-center justify-center mt-8 md:mt-12 bg-primary text-primary-foreground px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-primary hover:bg-[var(--brand-red-dark)] hover:outline-[var(--brand-red-dark)] transition leading-none btn-pulse-red"
            >
      ...
      <section className="py-12 px-5 bg-foreground text-background relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              [
                ...
                "Until you taste a real extra virgin with origin, intensity and flavor.",
              ],
              [
                "Olive oil is only for cooking.",
                "The final drizzle is what brings aroma, texture and personality to the dish.",
              ],
              [
                "A beautiful bottle means quality.",
                "What truly matters is origin, process, purity and flavor.",
              ],
              [
                "The cheapest one gets the job done.",
                "Until you realize your meals could taste so much better with the right olive oil.",
              ],
            ].map(([myth, truth]) => (
              <div key={myth} className="border-l-4 border-primary pl-6 py-3">
                <p className="text-xl font-bold mb-2">
                  <span className="text-primary mr-2">✗</span>"{myth}"
                </p>
          ...
          <p className="text-center mt-14 text-2xl font-display uppercase">
            Good olive oil is not a detail. It's the{" "}
            <span className="text-primary">difference</span> on the plate.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-6xl uppercase leading-[0.95]">
              Not another bottle.
              <br />A <span className="text-primary">complete kitchen experience.</span>
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
            {[
              ...
              <div
                key={t}
                className="bg-[var(--brand-cream)] border-2 border-foreground rounded-2xl p-6 hover:bg-primary hover:text-primary-foreground transition"
              >
          ...
          <div className="bg-[var(--brand-combines-bg)] text-background rounded-3xl p-10 grid md:grid-cols-2 gap-8 items-center border-4 border-foreground shadow-[var(--shadow-card)]">
            <div>
              ...
              <p className="mt-2 text-background/70">
                Here, you don't just buy olive oil. You bring the real taste of Sicily into your
                everyday routine.
              </p>
              <a
                href="#shop"
                className="inline-flex items-center justify-center mt-6 bg-primary text-primary-foreground px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-primary hover:bg-secondary hover:outline-secondary transition leading-none btn-pulse-red"
              >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-lg opacity-90 max-w-md">
              Sometimes all a meal needs is a drizzle of real extra virgin olive oil. Replace heavy
              dressings with a simple, premium, flavorful finishing touch.
            </p>
            ...
            <a
              href="#shop"
              className="inline-flex items-center justify-center mt-8 bg-primary text-primary-foreground px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-primary hover:bg-foreground hover:outline-foreground transition leading-none btn-pulse-red"
            >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-5 max-w-2xl mx-auto text-muted-foreground">
              People may notice the design first. But when they taste CIAO!, they understand the
              difference.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            {[
              [
                "★★★★★",
                '"Tastes like Italy in a bottle. The squeeze is a game-changer."',
                "— Marta R.",
              ],
              [
                "★★★★★",
                '"Bold, fresh, real. The finishing oil transformed my pasta nights."',
                "— Daniel K.",
              ],
              ...
              <article
                key={name}
                className="bg-[var(--brand-cream)] border-2 border-foreground rounded-2xl p-6"
              >
          ...
          <ul className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3 text-sm">
            {[
              "Positive marketplace reviews",
              "Excellent product acceptance",
              "Growing in the US market",
              "Sensory experience from first use",
              "Complete daily + gift portfolio",
            ].map((x) => (
              <li
                key={x}
                className="bg-secondary text-secondary-foreground rounded-full px-4 py-2.5 text-center font-medium min-h-[56px] flex items-center justify-center leading-tight"
              >
                {x}
              </li>
            ))}
          ...
          <div className="text-center mt-10">
            <a
              href="#shop"
              className="inline-flex items-center justify-center bg-primary text-primary-foreground px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-primary hover:bg-foreground hover:outline-foreground transition leading-none btn-pulse-red"
            >
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            {[
              ...
              "Appreciates design",
              "Tasteful gifting",
              "Turns simple into special",
            ].map((x) => (
              <span
                key={x}
                className="inline-flex items-center justify-center bg-background border-2 border-foreground rounded-full px-5 py-2.5 text-sm font-bold uppercase tracking-wide hover:bg-primary hover:text-primary-foreground hover:border-primary transition leading-none"
              >
                {x}
              </span>
            ))}
          ...
          <p className="mt-10 text-lg text-muted-foreground max-w-xl mx-auto">
            If you believe good food starts with good ingredients,{" "}
            <strong className="text-foreground">CIAO! is for you.</strong>
          </p>
          <a
            href="#shop"
            className="inline-flex items-center justify-center mt-6 bg-foreground text-background px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-foreground hover:bg-primary hover:outline-primary transition leading-none btn-pulse-black"
          >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          <div className="bg-[var(--brand-cream)] border-4 border-foreground rounded-3xl p-8">
            ...
            <ul className="mt-6 space-y-2 font-[var(--font-mono)]">
              {[
                "Authentic Sicilian origin",
                "Zero blend extra virgin",
                "Organic & Kosher certified",
                "Cold pressed process",
                "Practical squeeze bottle",
                "Modern, desirable design",
                "Clear cooking + finishing strategy",
                "Infused oils & gift packs",
              ].map((x) => (
          ...
          <div className="relative overflow-hidden border-4 border-foreground rounded-3xl p-8 flex flex-col justify-between text-white min-h-[460px]">
            ...
            />
            <div
              className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/50 to-black/10"
              aria-hidden
            />
            <div className="relative max-w-[60%] z-10">
              <h3 className="text-3xl md:text-4xl uppercase drop-shadow-[0_2px_10px_rgba(0,0,0,0.7)]">
                Premium. Fun.
                <br />
                Truly Sicilian.
              </h3>
              <p className="mt-4 text-white/95 drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)]">
                Other olive oils may look premium. But many have generic origin, little
                transparency, little personality. CIAO! is made to be{" "}
                <strong>used, displayed and remembered.</strong>
              </p>
            </div>
            <a
              href="#shop"
              className="relative z-10 inline-flex items-center justify-center mt-6 bg-background text-foreground px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-background hover:bg-foreground hover:text-background hover:outline-foreground transition self-start shadow-[0_8px_24px_rgba(0,0,0,0.35)] leading-none btn-pulse-white"
            >
