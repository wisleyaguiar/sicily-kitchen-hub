  ...
  return (
    <section id="why" className="py-12 px-5 bg-[var(--brand-cream)]">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-4xl md:text-6xl uppercase">A Sicilian Ritual.<br/>On Your Table.</h2>
        ...
        <a href="#shop" className="inline-flex items-center justify-center mt-10 bg-foreground text-background px-8 py-4 md:px-10 md:py-5 text-base md:text-lg font-bold uppercase tracking-wider rounded-full outline outline-2 outline-offset-2 outline-foreground hover:bg-primary hover:outline-primary transition leading-none btn-pulse-black">
